...
# APEX - Enable updating of APEXes
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/config/permissions/privapp-permissions-hotword.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-hotword.xml
...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.light@2.0-service.xiaomi_dipper

# LiveDisplay
PRODUCT_PACKAGES += \
    vendor.lineage.livedisplay@2.0-service-sdm \
    vendor.lineage.livedisplay@2.0-service.xiaomi_dipper
...
# Inherit the proprietary files / non-open-source specific aspects
